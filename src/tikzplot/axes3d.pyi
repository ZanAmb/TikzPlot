...
class Axes3:
    ...
    def set_xticks(self, ticks: Any, labels: Any = ..., **kwargs: Any) -> None: ...
    def set_yticks(self, ticks: Any, labels: Any = ..., **kwargs: Any) -> None: ...
    def set_zticks(self, ticks: Any, labels: Any = ..., **kwargs: Any) -> None: ...
    def set_xticklabels(self, labels: Any, **kwargs: Any) -> None: ...
    def set_yticklabels(self, labels: Any, **kwargs: Any) -> None: ...
    def set_zticklabels(self, labels: Any, **kwargs: Any) -> None: ...
    ...
    def grid(self, visible: bool = ..., which: str = ..., **kwargs: Any) -> None: ...
